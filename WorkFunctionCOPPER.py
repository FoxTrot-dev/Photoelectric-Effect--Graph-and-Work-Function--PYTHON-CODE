...
W_Theo = 4.70; # Theoretical Value of Work Function of Cu in eV
...
print("The work function of Cu metal (in joule) = ")
print (W_in_joule , "joule")
print("The work function of Cu metal (in eV) = ")
print (W_in_eV,"eV")

#Error Calculation
print("Theoretical Value of WorkFunction of Cu:-", W_Theo ,"eV" )
print("Calculated Value of WorkFunction of Cu:-",W_in_eV,"eV")
